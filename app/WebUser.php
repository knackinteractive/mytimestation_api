 ...
 * @property boolean $is_create_edit_admin [TYPE=BOOLEAN, NULLABLE=1, DEFAULT=""]
 * @property boolean $is_create_edit_dept [TYPE=BOOLEAN, NULLABLE=1, DEFAULT=""]
 * @property boolean $is_create_edit_emp [TYPE=BOOLEAN, NULLABLE=1, DEFAULT=""]
 ...
 * @property boolean $is_view_gps_location [TYPE=BOOLEAN, NULLABLE=1, DEFAULT=""]
...
class WebUser extends Model
{
	...
	protected $fillable = [
		...
		'hours_format', 'auto_time_deduct', 'attndnce_every_hours', 'default_report_date_range', 'card_info_1',
		'card_info_2', 'card_info_3', 'card_info_4', 'card_font_size', 'perm_type', 'is_authorize_ts_devices',
		'is_create_edit_admin', 'is_create_edit_dept', 'is_create_edit_emp', 'is_create_time_entries',
		'is_edit_company_settings', 'is_edit_time_entries', 'is_manage_billing_plan', 'is_print_employee_cards',
		'is_run_reports', 'is_view_gps_location', 'is_view_pay_info', 'is_admin', 'created_by', 'created_at'
	];
	protected $guarded = [];
